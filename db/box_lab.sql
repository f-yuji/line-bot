...
alter table box_signals add column if not exists entered_at timestamptz;
alter table box_signals add column if not exists virtual_trade_id uuid;
alter table box_signals add column if not exists skip_reason text;
alter table box_signals add column if not exists checked_at timestamptz;
...
alter table box_virtual_trades add column if not exists signal_id uuid;
alter table box_virtual_trades add column if not exists entry_mode text;
alter table box_virtual_trades add column if not exists entry_reason text;
alter table box_virtual_trades add column if not exists exit_rule text;
alter table box_virtual_trades add column if not exists take_profit_price numeric;
alter table box_virtual_trades add column if not exists stop_loss_price numeric;
alter table box_virtual_trades add column if not exists box_score numeric;
alter table box_virtual_trades add column if not exists box_high numeric;
alter table box_virtual_trades add column if not exists box_low numeric;
alter table box_virtual_trades add column if not exists box_width_pct numeric;
alter table box_virtual_trades add column if not exists box_position_pct numeric;
alter table box_virtual_trades add column if not exists bounce_count integer;
alter table box_virtual_trades add column if not exists margin_ratio numeric;
alter table box_virtual_trades add column if not exists margin_date date;
alter table box_virtual_trades add column if not exists rsi14 numeric;
alter table box_virtual_trades add column if not exists atr_pct numeric;
alter table box_virtual_trades add column if not exists volume_ratio_20d numeric;
alter table box_virtual_trades add column if not exists current_price numeric;
alter table box_virtual_trades add column if not exists unrealized_pnl numeric;
alter table box_virtual_trades add column if not exists unrealized_pnl_pct numeric;
alter table box_virtual_trades add column if not exists sell_date timestamptz;
alter table box_virtual_trades add column if not exists exit_date date;
alter table box_virtual_trades add column if not exists sell_price numeric;
alter table box_virtual_trades add column if not exists exit_price numeric;
alter table box_virtual_trades add column if not exists exit_reason text;
alter table box_virtual_trades add column if not exists profit_loss numeric;
alter table box_virtual_trades add column if not exists profit_loss_pct numeric;
alter table box_virtual_trades add column if not exists profit_pct numeric;
alter table box_virtual_trades add column if not exists holding_days integer;
