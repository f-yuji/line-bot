...
`h5_ai65_pb20_hd3_est12_cm_range330_live_limited` が現行の仮想売買 Primary（Live Limited）。全候補追跡用の Research ケース（`_research`）と2本立てで運用。2023〜2024 train / 2025〜 test で Forward-Test 実施済み。
